...
class _CadastroNomeScreenState extends State<CadastroNomeScreen> {
  ...
  final TextEditingController _nomeController =
      TextEditingController(); //add essas linhas abaixo
            ...
            child: SingleChildScrollView(
                child: Column(
                  ...
                  if (_etapaAtual == 0) ...[
                    ...
                    Align(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          fontFamily:
                              'Helvetica', // Define a fonte personalizada
                          fontSize:
                              25, // Tamanho do texto (ajuste conforme necessário)
                        ),
                    ...
                    TextField(
                      controller:
                          _nomeController, // Controlador do campo de texto
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                              color: const Color.fromARGB(255, 2, 122, 14)),
                        ),
                      ),
                    ),
                    SizedBox(height: 16),
                    ...
                    TextField(
                      controller:
                          _dataNascimentoController, // Controlador do campo de texto
                      style: TextStyle(color: Colors.black),
                      decoration: InputDecoration(
                        hintText: '00/00/0000',
                        hintStyle: TextStyle(color: Colors.grey),
                    ...
                    TextField(
                      controller:
                          _telefoneController, // Controlador do campo de texto
                      style: TextStyle(color: Colors.black),
                      decoration: InputDecoration(
